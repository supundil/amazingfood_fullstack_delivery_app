...
const DBNewItem = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div
        className="border border-gray-300 rounded-md p-4 w-full flex flex-col 
  ...
  return (
    <>
      <input
        ...
        className="w-full px-4 py-3 bg-lightOverlay shadow-md outline-none rounded-md border 
