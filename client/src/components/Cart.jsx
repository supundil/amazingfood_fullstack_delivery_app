        ...
        {cart && cart?.length > 0 ? (
          <>
            <div
              ...
              gap-3 h-[65%] overflow-y-scroll scrollbar-none px-4"
            >
              {cart &&
                cart?.length > 0 &&
                cart?.map((item, i) => (
            ...
            <div
              className="bg-zinc-800 round-t-[60px] w-full h-[35%] flex 
      flex-col items-center justify-center px-4 py-6 gap-24 "
            >
              <div className="w-full flex items-center justify-evenly">
                <p className="text-3xl text-zinc-500 font-semibold">Total</p>
                <p
                  className="text-3xl text-red-500 font-semibold flex 
...
export const CartItemCard = ({ index, data }) => {
  ...
  return (
    ...
    bg-zinc-800 rounded-md drop-shadow-md px-4 gap-4"
    >
      <img
        src={data?.imageURL}
